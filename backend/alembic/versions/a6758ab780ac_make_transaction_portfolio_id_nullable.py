...
def upgrade() -> None:
    ...
    # 修改外鍵約束為 SET NULL
    op.drop_constraint('fk_transactions_portfolio_id', 'transactions', type_='foreignkey')
    op.create_foreign_key('fk_transactions_portfolio_id', 'transactions', 'user_portfolios',
                          ['portfolio_id'], ['id'], ondelete='SET NULL')
