...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('user_id', postgresql.UUID(as_uuid=True), nullable=False, comment='用戶ID'),
        sa.Column('stock_id', sa.Integer(), nullable=False, comment='股票ID'),
        sa.Column('quantity', sa.Numeric(20, 4), nullable=False, server_default='0', comment='持有數量'),
        sa.Column('avg_cost', sa.Numeric(20, 4), nullable=False, server_default='0', comment='平均成本（單價）'),
        sa.Column('total_cost', sa.Numeric(20, 4), nullable=False, server_default='0', comment='總成本'),
        sa.Column('created_at', sa.DateTime(timezone=True), server_default=sa.text('now()'), nullable=False, comment='創建時間'),
        sa.Column('updated_at', sa.DateTime(timezone=True), server_default=sa.text('now()'), nullable=False, comment='更新時間'),
        sa.ForeignKeyConstraint(['stock_id'], ['stocks.id'], name='fk_user_portfolios_stock_id', ondelete='CASCADE'),
        sa.ForeignKeyConstraint(['user_id'], ['users.id'], name='fk_user_portfolios_user_id', ondelete='CASCADE'),
        sa.PrimaryKeyConstraint('id', name='pk_user_portfolios'),
        sa.UniqueConstraint('user_id', 'stock_id', name='uq_user_portfolios_user_id_stock_id'),
        comment='用戶持倉表'
    )
    ...
    op.create_table(
        ...
        sa.Column('stock_id', sa.Integer(), nullable=False, comment='股票ID'),
        sa.Column('transaction_type', sa.String(10), nullable=False, comment='交易類型（BUY/SELL）'),
        sa.Column('quantity', sa.Numeric(20, 4), nullable=False, comment='交易數量'),
        sa.Column('price', sa.Numeric(20, 4), nullable=False, comment='交易價格（單價）'),
        sa.Column('fee', sa.Numeric(20, 4), nullable=False, server_default='0', comment='交易手續費'),
        sa.Column('tax', sa.Numeric(20, 4), nullable=False, server_default='0', comment='交易稅'),
        sa.Column('total', sa.Numeric(20, 4), nullable=False, comment='總金額（含手續費和稅）'),
        sa.Column('transaction_date', sa.Date(), nullable=False, comment='交易日期'),
        sa.Column('note', sa.Text(), nullable=True, comment='備註'),
        sa.Column('created_at', sa.DateTime(timezone=True), server_default=sa.text('now()'), nullable=False, comment='創建時間'),
        sa.Column('updated_at', sa.DateTime(timezone=True), server_default=sa.text('now()'), nullable=False, comment='更新時間'),
        sa.ForeignKeyConstraint(['portfolio_id'], ['user_portfolios.id'], name='fk_transactions_portfolio_id', ondelete='CASCADE'),
        sa.ForeignKeyConstraint(['stock_id'], ['stocks.id'], name='fk_transactions_stock_id', ondelete='CASCADE'),
        sa.ForeignKeyConstraint(['user_id'], ['users.id'], name='fk_transactions_user_id', ondelete='CASCADE'),
    ...
    op.create_index('idx_transactions_stock_date', 'transactions', ['stock_id', 'transaction_date'])
